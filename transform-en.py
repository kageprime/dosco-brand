...
REWRITES = {
    ...
    'Dosco, AI command center, AI agents, AI workforce, AI platform, ed AI agents, AI automation, agent orchestration, AI-native company, build AI agents, connect 3000 tools, AI operations': 'Dosco, agentic OS, AI agents, AI workforce, AI platform, private AI agents, AI automation, agent orchestration, AI-native company, build AI agents, connect 3000 tools, AI operations',
    ...
    'Kortix, AI command center, AI agents, AI workforce, open source AI platform, self-hosted AI agents, AI automation, agent orchestration, AI-native company, build AI agents, connect 3000 tools, AI operations': 'Dosco, agentic OS, AI agents, AI workforce, AI platform, private AI agents, AI automation, agent orchestration, AI-native company, build AI agents, connect 3000 tools, AI operations',
