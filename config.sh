...
export DOSCO_CANONICAL="${DOSCO_CANONICAL:-https://dosco.live}"
...
# Locations.
export SUNA_REPO="/root/dosco-suna"
export BRAND_DIR="/root/dosco-brand"
...
export KORTIX_ENV="/root/.config/kortix/self-host/default/.env"
